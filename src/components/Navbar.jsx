    ...
    <nav className="bg-white border-b border-gray-100 sticky top-0 z-50 shadow-sm">
      <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          {user && (
            <Link href="/dashboard" className="text-gray-600 hover:text-sky-500 text-sm font-medium">Dashboard</Link>
          )}
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-4">
          ...
          {user && (
            <Link href="/dashboard" className="text-gray-600 text-sm font-medium">Dashboard</Link>
          )}
            ...
            {user ? (
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  {user.image ? (
                    <img src={user.image} alt="profile" className="w-8 h-8 rounded-full border border-sky-500" />
                  ) : (
