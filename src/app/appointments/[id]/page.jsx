...
export default function DoctorDetails({ doctor }) {
  ...
  // 🔄 বুকিং এর জন্য কারেন্ট লগইন থাকা ইউজারের ডাটা নিয়ে আসা
  ...
  const handleBooking = async (e) => {
    ...
    try {
      // আপনার রেন্ডার সার্ভারের URL ব্যবহার করা হয়েছে
      ...
      if (data.success) {
        ...
        router.push("/dashboard"); // বুকিং সফল হলে ড্যাশবোর্ড বা হোম পেজে নিয়ে যাবে
      } else {
